...
class PostForm(forms.ModelForm):
    class Meta:
        ...
        widgets={
            ...
            'title_tag': forms.TextInput(attrs={'class':'form-control', 'placeholder': 'Enter the title tag of your blog post'}),
            #'author': forms.Select(attrs={'class':'form-control'}),
            'author': forms.TextInput(attrs={'class':'form-control','value': '', 'id': 'raha', 'type': 'hidden'}),
